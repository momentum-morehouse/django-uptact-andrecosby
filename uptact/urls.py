...
from contacts.views import add_note, contact_detail
...
urlpatterns = [
    ...
    path("contacts/<int:pk>/", 
         contacts_views.contact_detail, name="contact_detail"),

    path("contacts/<int:pk>/notes/", contacts_views.add_note, name="contact_detail"),
]         
